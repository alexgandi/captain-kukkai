...
export default class SpaceScene extends Phaser.Scene {
  ...
  fireLaser() {
    ...
    laser.setVelocityX(LASER_SPEED);
    laser.setDepth(8);
  ...
  startBossFight() {
    ...
    // Kukkai prigioniera in un raggio traente sotto al boss.
    this.kukkaiBeam = this.add.circle(bx, by + 66, 22, 0x37e0ff, 0.25).setDepth(8);
    this.kukkaiCaptive = this.add.image(bx, by + 66, 'kukkai_portrait').setScale(0.42).setDepth(9);
